...
class Background
{
    ...
    int first = 0;
    std::string picture[4]= {"../Assets/Backgrounds/3/background.png", "../Assets/Backgrounds/2/background.png", "../Assets/Backgrounds/3/background.png", "../Assets/Backgrounds/1/background.png"};
    sf::Texture images[4];
